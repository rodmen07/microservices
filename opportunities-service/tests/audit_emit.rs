...
//!
//! `opportunities-service/openapi.yaml:202` documents, in the present tense, that a
...
use opportunities_service::handlers::opportunities::emit_audit;
...
/// are the literals this service's own handlers pass (`opportunities.rs` call sites
...
const ENTITY_TYPE: &str = "opportunity";
const ACTION: &str = "created";
const ENTITY_ID: &str = "oppo-11111111-2222-3333-4444-555555555555";
const ACTOR_ID: &str = "user-a1b2c3";
const ENTITY_LABEL: &str = "Globex platform migration";
const AUTH_HEADER: &str = "Bearer header.payload.signature-opportunities";
