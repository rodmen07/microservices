...
//!
//! `contacts-service/openapi.yaml:265` documents, in the present tense, that a
...
/// are the literals this service's own handlers pass (`contacts.rs` call sites
...
const ENTITY_TYPE: &str = "contact";
const ACTION: &str = "created";
const ENTITY_ID: &str = "cont-11111111-2222-3333-4444-555555555555";
const ACTOR_ID: &str = "user-a1b2c3";
const ENTITY_LABEL: &str = "Ada Lovelace";
