...
//!
//! `accounts-service/openapi.yaml:225` documents, in the present tense, that a
...
use accounts_service::handlers::accounts::emit_audit;
...
/// are the literals this service's own handlers pass (`accounts.rs` call sites
...
const ENTITY_ID: &str = "acct-11111111-2222-3333-4444-555555555555";
const ACTOR_ID: &str = "user-a1b2c3";
const ENTITY_LABEL: &str = "Globex Corporation";
const AUTH_HEADER: &str = "Bearer header.payload.signature-accounts";
